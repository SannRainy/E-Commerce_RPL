  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="max-w-4xl mx-auto py-10 px-4">
        <h1 className="text-3xl font-bold mb-8 text-gray-800">Selesaikan Pesanan Anda</h1>
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-white p-6 rounded-lg border">
            ...
            {product.imageUrl && (
              <img
              src={`${API_URL ? API_URL.replace('/api', '') : ''}${product.imageUrl}`}
              alt={product.name}
            ...
            <p className="text-2xl font-bold text-jade mt-4">
          ...
          <div className="bg-white p-6 rounded-lg border">
            ...
            <form onSubmit={handleSubmitOrder}>
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-jade focus:border-jade"
                  />
                </div>
                <div>
              ...
              <button
                type="submit"
                className="mt-6 w-full bg-jade text-white py-3 rounded-md hover:bg-jade/80 transition font-bold text-lg"
              >
                Pesan Sekarang
              </button>
            </form>
