...
function UserPage() {
    ...
    const fetchUsers = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${API_URL}/users`);
            setUsers(res.data);
        } catch (err) {
    ...
    const updateUserRole = async (userId, newRole)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`${API_URL}/users/${userId}/role`, {
                role: newRole
            });
    ...
    const deleteUser = async (userId)=>{
        if (window.confirm('Apakah Anda yakin ingin menghapus pengguna ini?')) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`${API_URL}/users/${userId}`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ac8b62e._.js.map