...
function CategoryDashboard() {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (!name.trim()) return;
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/categories`, {
                name
            });
            setCategories((prev)=>[
                    ...prev,
    ...
    const deleteCategory = async (id)=>{
        if (window.confirm('Apakah Anda yakin ingin menghapus kategori ini?')) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`${API_URL}/categories/${id}`);
    ...
    const renderContent = ()=>{
        ...
        if (categories.length === 0) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            className: "p-6 text-center text-gray-500",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ad9c0cc7._.js.map