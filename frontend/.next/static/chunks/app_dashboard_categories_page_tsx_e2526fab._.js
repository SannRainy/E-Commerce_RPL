...
function CategoryDashboard() {
    ...
    const fetchCategories = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API_URL}/categories`);
    ...
    const handleSubmit = async (e)=>{
        ...
        if (!name.trim()) return;
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/categories`, {
                name
            });
            setCategories((prev)=>[
                    ...prev,
    ...
    const deleteCategory = async (id)=>{
        if (window.confirm('Apakah Anda yakin ingin menghapus kategori ini?')) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${API_URL}/categories/${id}`);
    ...
    const renderContent = ()=>{
        ...
        if (categories.length === 0) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            className: "p-6 text-center text-gray-500",
            children: "Belum ada kategori yang ditambahkan."
        }, void 0, false, {
            fileName: "[project]/app/dashboard/categories/page.tsx",
            lineNumber: 70,
            columnNumber: 14
...
_s(CategoryDashboard, "ebJFF7jpBqVC86ofc5t/Oh++Bpo=");
_c = CategoryDashboard;
var _c;
__turbopack_context__.k.register(_c, "CategoryDashboard");
...
//# sourceMappingURL=app_dashboard_categories_page_tsx_e2526fab._.js.map