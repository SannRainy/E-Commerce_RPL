...
function AuthForm({ type }) {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        setLoading(true);
        const endpoint = `${("TURBOPACK compile-time value", "http://localhost:5000/api")}/auth/${type}`;
        ...
        try {
            ...
            if (res.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(isLogin ? 'Login berhasil!' : 'Registrasi berhasil!');
                // Panggil fungsi login dari context untuk menyimpan data user
                login(data.token, data.result);
                router.push("/dashboard/products");
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(data.message || "Terjadi kesalahan");
            }
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Gagal terhubung ke server. Pastikan API aktif.");
...
_s(AuthForm, "qJR9rxiIpXEYoslutYM4bClV8vM=", false, function() {
    return [
